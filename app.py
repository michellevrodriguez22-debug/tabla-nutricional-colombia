...
# ... (todo el bloque de cálculos y validaciones idéntico) ...
...
# ============================================================
# 🔧 FUNCIÓN MODIFICADA — TABLAS MÁS COMPACTAS (FIG. 1, 3 y 4)
# ============================================================
def compute_cols_compact(draw, labels, v100_list, vpp_list, W, left_margin=18, right_margin=10):
    """
    Igual que tu versión original, pero reduce el margen derecho y la
    separación entre 'Por 100' y 'Por porción' para compactar la tabla.
    """
    name_w_max = 0
    for t in labels:
    ...
    # 🔹 Ajuste real de compactación
    x0 = BORDER_W + left_margin
    x1 = x0 + CELL_PAD_X + name_w_max + CELL_PAD_X
    x2 = x1 + v100_w_max + CELL_PAD_X + 2   # antes +10 → más pegado
    x3 = W - BORDER_W - right_margin         # margen derecho reducido (20→10)
...
def draw_fig1():
    ...
    col_x = compute_cols_compact(d, labels_all, v100_all+[c100], vpp_all+[cpp], W)
    ...
    for label, v100, vpp, indent, bold, _ in rows_nutri:
        ...
        wv100,_ = measure_text(d, v100, font_lbl)
        wvpp,_  = measure_text(d, vpp,  font_lbl)
        d.text((col_x[2]-CELL_PAD_X-wv100, y_text), v100, fill=TEXT_COLOR, font=font_lbl)
        d.text((col_x[3]-CELL_PAD_X-wvpp,  y_text), vpp,  fill=TEXT_COLOR, font=font_lbl)
        y += ROW_H
    if show_micro:
...
# ============================================================
# ... (idéntico a tu versión original, ya usando compute_cols_compact)
# ============================================================
# FIGURA 4 — TABULAR
# ============================================================
# ... (idéntico a tu versión original, ya usando compute_cols_compact)
