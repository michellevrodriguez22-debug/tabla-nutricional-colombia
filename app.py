...
# ---- Reglas de redondeo (basadas en 810/2021) y "cantidades no significativas" ----
def round_kcal(v):
    # <5 kcal puede declararse 0; en general entero
    if v < 5:
        return 0
    return int(round(v))

def round_g(v):
    # general: 1 decimal para la mayoría de rangos; enteros para >=100
    av = abs(v)
    if av < 0.5:
...
def round_mg(v_mg):
    # <5 mg -> 0 mg (caso sodio y coherencia mg)
    if v_mg < 5:
        return 0
...
# ============================================================
# ESTILO GRÁFICO (debe ir ANTES de las funciones que lo usan)
# ============================================================
BORDER_W       = 6
GRID_W         = 3
GRID_W_THICK   = 9
...
# “No significativas” por nutriente (heurísticas alineadas a norma)
...
# trans por 100: entrada mg -> g para regla no significativa y regreso a mg
...
# Micronutrientes por porción (redondeo entero)
vm_pp = {}
vm_values_rounded = {}
